...
import DeveloperOptionsScreen from "../screen/DeveloperOptionsScreen";
import * as BackgroundRegister from "./BackgroundRegister";
                    ...
                    tabBarIcon: ({focused}) => (
                        <Image
                            source={
                                focused
                                    ? require('../assets/images/wow.png')
                                    : courseCount ? require('../assets/images/allert.png') : require('../assets/images/normal.png')
                            }
                            style={styles.navIcon}
                        />
                    ),
