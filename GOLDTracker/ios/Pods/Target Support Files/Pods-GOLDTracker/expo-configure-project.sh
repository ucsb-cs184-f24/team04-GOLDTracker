...
with_node \
  ...
  --target "/Users/junebi/Desktop/team04-GOLDTracker/GOLDTracker/ios/Pods/Target Support Files/Pods-GOLDTracker/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-web-browser"
