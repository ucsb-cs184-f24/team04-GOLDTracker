...
with_node \
  ...
  --target "/Users/anna/Documents/team04-GOLDTracker/GOLDTracker/ios/Pods/Target Support Files/Pods-GOLDTracker/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-web-browser"
