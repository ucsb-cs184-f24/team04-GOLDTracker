...
class MetroTerminalReporter extends _terminalReporter.TerminalReporter {
   ...
   */ _getBundleStatusMessage(progress, phase) {
        ...
        let localPath;
        if (typeof ((ref = progress.bundleDetails) == null ? void 0 : (ref1 = ref.customTransformOptions) == null ? void 0 : ref1.dom) === "string" && progress.bundleDetails.customTransformOptions.dom.includes("/")) {
            ...
            localPath = inputFile.startsWith(_path().default.sep) ? _path().default.relative(this.projectRoot, inputFile) : inputFile;
        }
        if (!inProgress) {
